"""Set the SCRATCH anchor's dial dock and live theme, for items 3 and 4.

Run 11's trap, restated because it cost that run a whole before/after: the LIVE
theme is NOT library.json's Theme/ThemeSource - those are a stale mirror.  It is
settings.json -> Settings.Theme and Ui.Theme, and BOTH have to move.
...
Usage: python vp11_setup.py <anchor> <theme>
"""
import json
import os
import sys

ROOT = r'C:\Users\irony\Downloads\Quill Gem - Fable\Quill\scratchpad\vp11data'
