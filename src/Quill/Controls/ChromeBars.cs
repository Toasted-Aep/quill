...
public sealed class ChromeBars
{
    ...
    private FrameworkElement BuildLayersPanel()
    {
        ...
        panel.Children.Add(ChromeUi.Caption(
            ...
            "layer: it always sits below them, and hiding or reordering layers leaves it exactly as it was. " +
            "Text boxes always sit above the drawing, whatever the layer order."));
