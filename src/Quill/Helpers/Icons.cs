...
public static class Icons
{
    ...
    public const string UndoRound =
        // A thin round-capped ring with an open CHEVRON head, per the user's
        // reference: stroke drawing, thin body, rounded at both ends, generous
        ...
        //
        // The outline is FLATTENED to line segments. The previous version built
        // its caps from `A` commands, and a cap whose sweep flag is wrong bulges
        // inward and yields bowtie geometry - which is exactly why it rendered
        // as a blob rather than an arrow. Sampling the offset curve removes the
        // class of bug entirely: no flags are left to get backwards. The cap
        // direction is chosen by which sweep bulges along the tangent, i.e. by
        // geometry rather than by a hand-set flag.
        //
        // Generated by scratchpad/gen_undo.py; regenerate rather than hand-edit.
        "M17.36 5.44 L17.72 5.73 L18.06 6.04 L18.38 6.37 L18.68 6.71 L18.97 7.07 L19.23 7.45" +
        "L19.48 7.83 L19.7 8.23 L19.91 8.65 L20.09 9.07 L20.25 9.5 L20.38 9.94 L20.5 10.38" +
        "L20.59 10.83 L20.65 11.29 L20.69 11.74 L20.71 12.2 L20.7 12.66 L20.67 13.12 L20.62" +
        "13.58 L20.54 14.03 L20.43 14.48 L20.31 14.92 L20.16 15.35 L19.99 15.78 L19.79 16.19" +
        "L19.58 16.6 L19.34 16.99 L19.08 17.37 L18.8 17.74 L18.51 18.09 L18.19 18.42 L17.86" +
        "18.74 L17.51 19.04 L17.15 19.32 L16.77 19.59 L16.38 19.83 L15.98 20.05 L15.57 20.25" +
        "L15.14 20.42 L14.71 20.58 L14.27 20.71 L13.82 20.82 L13.37 20.9 L12.92 20.96 L12.46" +
        "21 L12 21.01 L11.54 21 L11.08 20.96 L10.63 20.9 L10.18 20.82 L9.73 20.71 L9.29" +
        "20.58 L8.86 20.42 L8.43 20.25 L8.02 20.05 L7.62 19.83 L7.23 19.59 L6.85 19.32 L6.49" +
        "19.04 L6.14 18.74 L5.81 18.42 L5.49 18.09 L5.2 17.74 L4.92 17.37 L4.66 16.99 L4.42" +
        "16.6 L4.21 16.19 L4.01 15.78 L3.84 15.35 L3.69 14.92 L3.57 14.48 L3.46 14.03 L3.38" +
        "13.58 L3.33 13.12 L3.3 12.66 L3.29 12.2 L3.31 11.74 L3.35 11.29 L3.41 10.83 L3.5" +
        "10.38 L3.62 9.94 L3.75 9.5 L3.91 9.07 L4.09 8.65 L4.3 8.23 L4.52 7.83 L4.77 7.45" +
        "L5.03 7.07 L5.32 6.71 L5.62 6.37 L5.94 6.04 L6.28 5.73 L6.64 5.44 L6.79 5.35 L6.96" +
        "5.32 L7.14 5.34 L7.3 5.41 L7.42 5.53 L7.51 5.69 L7.54 5.86 L7.52 6.03 L7.45 6.19" +
        "L7.33 6.32 L7.33 6.32 L7.02 6.57 L6.72 6.84 L6.44 7.13 L6.18 7.43 L5.93 7.74 L5.7" +
        "8.07 L5.48 8.41 L5.29 8.76 L5.11 9.12 L4.95 9.48 L4.81 9.86 L4.69 10.24 L4.6 10.63" +
        "L4.52 11.02 L4.46 11.42 L4.43 11.82 L4.41 12.22 L4.42 12.62 L4.44 13.01 L4.49 13.41" +
        "L4.56 13.81 L4.65 14.2 L4.76 14.58 L4.89 14.96 L5.04 15.33 L5.21 15.69 L5.4 16.05" +
        "L5.61 16.39 L5.83 16.72 L6.07 17.04 L6.33 17.35 L6.6 17.64 L6.89 17.91 L7.2 18.18" +
        "L7.51 18.42 L7.84 18.65 L8.18 18.86 L8.53 19.05 L8.89 19.22 L9.26 19.38 L9.64 19.51" +
        "L10.02 19.63 L10.41 19.72 L10.8 19.8 L11.2 19.85 L11.6 19.88 L12 19.89 L12.4 19.88" +
        "L12.8 19.85 L13.2 19.8 L13.59 19.72 L13.98 19.63 L14.36 19.51 L14.74 19.38 L15.11" +
        "19.22 L15.47 19.05 L15.82 18.86 L16.16 18.65 L16.49 18.42 L16.8 18.18 L17.11 17.91" +
        "L17.4 17.64 L17.67 17.35 L17.93 17.04 L18.17 16.72 L18.39 16.39 L18.6 16.05 L18.79" +
        "15.69 L18.96 15.33 L19.11 14.96 L19.24 14.58 L19.35 14.2 L19.44 13.81 L19.51 13.41" +
        "L19.56 13.01 L19.58 12.62 L19.59 12.22 L19.57 11.82 L19.54 11.42 L19.48 11.02 L19.4" +
        "10.63 L19.31 10.24 L19.19 9.86 L19.05 9.48 L18.89 9.12 L18.71 8.76 L18.52 8.41" +
        "L18.3 8.07 L18.07 7.74 L17.82 7.43 L17.56 7.13 L17.28 6.84 L16.98 6.57 L16.67 6.32" +
        "L16.55 6.19 L16.48 6.03 L16.46 5.86 L16.49 5.69 L16.58 5.53 L16.7 5.41 L16.86 5.34" +
        "L17.04 5.32 L17.21 5.35 L17.36 5.44 Z M7.14 5.34 L2.43 3.99 L2.25 3.97 L2.08 4" +
        "L1.93 4.09 L1.81 4.21 L1.73 4.37 L1.71 4.55 L1.75 4.72 L1.83 4.87 L1.96 4.99 L2.12" +
        "5.07 L6.83 6.42 L7 6.44 L7.17 6.4 L7.33 6.32 L7.45 6.19 L7.52 6.03 L7.54 5.86 L7.51" +
        "5.69 L7.42 5.53 L7.3 5.41 L7.14 5.34 Z M6.42 5.9 L6.59 10.79 L6.63 10.97 L6.71" +
        "11.12 L6.84 11.24 L7 11.31 L7.17 11.33 L7.34 11.3 L7.5 11.22 L7.62 11.09 L7.69" +
        "10.93 L7.71 10.76 L7.54 5.86 L7.51 5.69 L7.42 5.53 L7.3 5.41 L7.14 5.34 L6.96 5.32" +
        "L6.79 5.35 L6.64 5.44 L6.52 5.56 L6.44 5.72 L6.42 5.9 Z";
