...
public static class Icons
{
    ...
    public const string UndoRound =
        // A thin round-capped ring with an open CHEVRON head - the user's
        // reference is a stroke drawing, not a solid arrow: thin body, rounded
        // ends at both the head and the tail, and a generous gap between them.
        //
        // Authored as a FILLED OUTLINE rather than a stroke, because the top bar
        // draws these through PathIcon, which fills its Data and cannot stroke.
        // The ring is an annulus closed by semicircular caps; each chevron leg is
        // a pill - which is precisely what a round-capped stroke's outline is. One
        // geometry therefore serves both PathIcon and Icons.Mark.
        //
        // The chevron's vertex sits exactly ON the stroke's end point with its
        // legs trailing back symmetrically about the tangent. Two earlier
        // attempts put the vertex further round the arc so head and ring merely
        // overlapped, and both fused into a blob; the legs also have to be long
        // and splayed enough (5.05 at 56 degrees) to clear the arc's own
        // curvature, or the same thing happens at 30 DIP.
        //
        // Sweep-flag 1 is CLOCKWISE in SVG's y-down space. Getting that backwards
        // draws the short arc and loses the ring entirely.
        // Generated by scratchpad/gen_undo.py; regenerate rather than hand-edit.
        "M17.54 5.74 A8.62 8.62 0 1 1 6.46 5.74 A0.57 0.57 0 0 1 7.2 6.62 A7.48 7.48 0" +
        "1 0 16.8 6.62 A0.57 0.57 0 0 1 17.54 5.74 Z M6.98 5.63 L2.13 4.24 A0.57 0.57" +
        "0 0 1 1.81 5.34 L6.67 6.74 A0.57 0.57 0 0 1 6.98 5.63 Z M6.25 6.24 L6.78" +
        "11.27 A0.57 0.57 0 0 1 7.93 11.15 L7.4 6.12 A0.57 0.57 0 0 1 6.25 6.24 Z";
