...
public static class Icons
{
    ...
    /// <summary>HELP (CONCEPTS-REF 5): the `?` that closes the top bar's right
    /// cluster, `... Import, Export, Settings (gear) and Help`. 15.3 transcribes
    /// the same mark at the end of the fullscreen cluster.
    ///
    /// <para>A FILLED OUTLINE of the glyph's stroke, not a font glyph and - per
    /// the standing rule - never an emoji. The top bar draws its marks through
    /// <see cref="Filled"/>, and <c>PathIcon</c> fills its Data and cannot
    /// stroke, so a mark that IS a stroke has to be emitted as that stroke's
    /// boundary.</para>
    ///
    /// <para><b>The gap between the tail and the dot is the whole mark.</b> Close
    /// it and a `?` reads as a `J`. It is 1.84 units on the 24 grid, which is
    /// 1.22 px at the 16 DIP <c>ChromeBars.Metrics.GlyphSize</c> actually draws -
    /// measured, not assumed, because 11.23 records two marks (the palette's
    /// wells, the star's arms) that were legible at preview size and had lost
    /// their read entirely at the size the app asked for. The stroke is 2.88
    /// units, 1.92 px at 16 DIP; the rings in this file run thinner (Zoom 2.0,
    /// Precision 1.8) because a ring encloses an area and reads at a weight a
    /// bare glyph does not.</para>
    ///
    /// <para>ONE LINE, like every literal below it: a break landing between a
    /// coordinate's x and its y fuses them into a number that cannot parse and
    /// the mark renders BLANK, while still compiling. Generated by
    /// scratchpad/gen_help_icon.py; regenerate rather than hand-edit. Extent
    /// x 6.59..17.41, y 2.50..21.50 on the 24 grid.</para></summary>
    public const string Help =
        "M 9.65 8.85 L 9.53 8.47 L 9.48 8.15 L 9.47 7.84 L 9.5 7.52 L 9.56 7.21 L 9.67 6.91 L 9.81 6.63 L 9.99 6.37 L 10.19 6.13 L 10.43 5.92 L 10.69 5.74 L 10.97 5.59 L 11.27 5.48 L 11.57 5.41 L 11.89 5.38 L 12.21 5.38 L 12.52 5.43 L 12.82 5.51 L 13.12 5.63 L 13.39 5.79 L 13.64 5.98 L 13.87 6.2 L 14.07 6.45 L 14.23 6.72 L 14.36 7 L 14.46 7.31 L 14.51 7.62 L 14.53 7.93 L 14.51 8.25 L 14.44 8.57 L 14.36 8.84 L 14.25 9.1 L 14.13 9.34 L 13.99 9.57 L 13.84 9.8 L 13.67 10.01 L 13.49 10.23 L 13.29 10.44 L 13.08 10.65 L 12.86 10.86 L 12.64 11.07 L 12.4 11.29 L 12.16 11.52 L 11.92 11.76 L 11.68 12.02 L 11.44 12.29 L 11.22 12.6 L 11.01 12.94 L 10.82 13.32 L 10.68 13.74 L 10.59 14.18 L 10.56 14.56 L 10.6 15.01 L 10.78 15.42 L 11.08 15.76 L 11.46 15.99 L 11.9 16.09 L 12.35 16.05 L 12.77 15.87 L 13.1 15.57 L 13.34 15.19 L 13.44 14.75 L 13.44 14.57 L 13.46 14.49 L 13.49 14.42 L 13.53 14.32 L 13.6 14.21 L 13.7 14.08 L 13.83 13.93 L 13.98 13.77 L 14.16 13.58 L 14.37 13.39 L 14.6 13.18 L 14.84 12.95 L 15.1 12.7 L 15.37 12.44 L 15.64 12.15 L 15.9 11.83 L 16.17 11.49 L 16.42 11.12 L 16.66 10.71 L 16.88 10.28 L 17.07 9.81 L 17.23 9.29 L 17.36 8.64 L 17.41 7.97 L 17.37 7.29 L 17.25 6.63 L 17.05 5.98 L 16.77 5.36 L 16.42 4.79 L 16 4.26 L 15.51 3.79 L 14.97 3.38 L 14.38 3.05 L 13.76 2.79 L 13.11 2.61 L 12.44 2.51 L 11.76 2.5 L 11.09 2.57 L 10.43 2.73 L 9.8 2.96 L 9.2 3.28 L 8.64 3.66 L 8.14 4.11 L 7.7 4.62 L 7.32 5.19 L 7.02 5.79 L 6.8 6.43 L 6.65 7.09 L 6.59 7.76 L 6.62 8.44 L 6.73 9.11 L 6.89 9.67 L 7.08 10.07 L 7.39 10.4 L 7.79 10.62 L 8.23 10.7 L 8.68 10.64 L 9.08 10.45 L 9.41 10.14 L 9.62 9.74 L 9.71 9.3 L 9.65 8.85 Z M 13.79 19.71 L 13.72 20.18 L 13.55 20.61 L 13.26 20.98 L 12.89 21.26 L 12.46 21.44 L 12 21.5 L 11.54 21.44 L 11.11 21.26 L 10.74 20.98 L 10.45 20.61 L 10.27 20.18 L 10.21 19.71 L 10.27 19.25 L 10.45 18.82 L 10.74 18.45 L 11.11 18.17 L 11.54 17.99 L 12 17.93 L 12.46 17.99 L 12.89 18.17 L 13.26 18.45 L 13.55 18.82 L 13.72 19.25 Z";
