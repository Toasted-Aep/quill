...
public sealed partial class MainWindow : Window
{
    ...
    private void ApplyGlowMode()
    {
        ...
        if (_reduceMotion || (_library.GlowMode != "Circulate" && _library.GlowMode != "Rainbow Flow")) RestoreCirculateStops();
    ...
    private async void Settings_Click(object sender, RoutedEventArgs e)
    {
        ...
        foreach (var mode in new[] { "Off", "Breathe", "Circulate", "Pulse", "Flicker", "Rainbow Flow" }) glowBox.Items.Add(mode);
        glowBox.SelectedItem = new[] { "Off", "Breathe", "Circulate", "Pulse", "Flicker", "Rainbow Flow" }.Contains(_library.GlowMode) ? _library.GlowMode : "Breathe";
